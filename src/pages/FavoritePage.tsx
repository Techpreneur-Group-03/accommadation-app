...
export function FavoritePage({ houses, favoriteIds, onToggleFavorite }: FavoritePageProps) {
    return (
        <section className="w-full" aria-label="Favorite accommodations">
            ...
            {houses.length === 0 ? (
                <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
                    ...
                    <h2 className="text-lg font-semibold text-slate-900">No favorites yet</h2>
